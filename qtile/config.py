...
# SUPER + FUNCTION KEYS
    ...
    Key([mod], "d", lazy.spawn('ranger-fix')),  #alacritty -e 
...
# INCREASE/DECREASE/MUTE VOLUME
    Key([], "XF86AudioMute", lazy.spawn("pamixer -t  #to mute")),
    Key([], "XF86AudioLowerVolume", lazy.spawn("pamixer -d 5 #to increase 5%")),
    Key([], "XF86AudioRaiseVolume", lazy.spawn("pamixer -i 5 #to decrease 5%")),  #deas
...
def init_colors():
    return [["#2F343F", "#2F343F"], # color 0
            ...
            ["#434c5e", "#434c5e"], # color 10  #6790eb Blue
            ["#ff00ff", "#ff00ff"], #11
            ["#4c566a", "#4c566a"], #12 
            ["#282c34", "#282c34"], #13
            ["#212121", "#212121"], #14
...
def base(fg='text', bg='dark'):
    return {'foreground': colors[10],'background': colors[10]}  # for:14 back:15  for the bar selection
...
def sep2():  # Deas user function
    return widget.Sep(linewidth = 1,
        padding = 2,
        foreground = colors[10], # deas [10]
        background = colors[10]  #[10]  
        )
...
def init_widgets_list():
    ...
    widgets_list = [
               ...
               widget.Image(
                       ...
                       filename = "~/.config/qtile/icons/Kiwi_white_2.png",
                       iconsize = 9,
                       background = colors[10], #[15]
                       mouse_callbacks = {'Button1': lambda : qtile.cmd_spawn('jgmenu_run')}
                       ),
                sep2(),
               widget.GroupBox(

            **base(bg=colors[15]), #[15]
...
#                        ),
               widget.Memory(
                        font="Noto Sans",
                        format = '{MemUsed: 0.2f}G/{MemTotal: 0.2f}G',  # M .0f
                        update_interval = 2,
                        fontsize = 12,
                        measure_mem = 'G', #M
                        foreground = colors[5],
...
def init_screens():
    return [Screen(top=bar.Bar(widgets=init_widgets_screen1(), size=20, opacity=0.80, background= "000000")),
            Screen(top=bar.Bar(widgets=init_widgets_screen2(), size=20, opacity=0.80, background= "000000"))] #opacity=0.85
